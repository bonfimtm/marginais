...
public class VideoController implements java.io.Serializable {
	...
	public void preparePagedVideos() {
		...
		try {
			...
			count = postFacade.countVideoPosts();
			pageItems = new PaginationHelper<Post>(count, pageNumber, 2) {

				@Override
				public List<Post> getData() {
					return postFacade.findVideoPostsOrderByIdDesc(begin, end);
				}
			};
